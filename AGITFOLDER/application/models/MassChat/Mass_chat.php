...
class Mass_chat extends CI_Model {
  ...
  {
    $this->climate->shout("  Type '<n>' for new lines ex: Hi👋<n>hello")->br();
  ...
  private function chats()
  {
    ...
    {
      $this->climate->out('    * ERRORS when send message: '.$this->fullname.' ('.$this->ids.')');
    }
  }
  ...
  public function execute()
  {
    ...
    {
      $this->climate->out('    * SUCCESS sended to: '.$this->ids.'');
    }
    else
    {
      $this->climate->out('    * ERRORS when send message: '.$this->fullname.' ('.$this->ids.')');
