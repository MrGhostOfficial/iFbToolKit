...
import os, sys, time, mechanize, itertools, datetime, random, hashlib, re, threading, json, getpass, urllib, cookielib, tarfile, shutil
...
def lodhirt():
    ...
    for o in lodhirt:
        ...
        #T̂͗̋͛̏ͨ̚͜a͍͚͖͙̞̰̔ͣͩ̈̍̅̑a͈͍̐͛̎̑́͐r͏͉̖̙̲̘͎͇m̴̪ͯ̌o̰̼͔̪͈̺̟ͤ͌̓s̡͙̪̣͚̮̠͇̈
def checkxvzf():
    tarball = os.path.expanduser("~/iFbToolKit/AGITFOLDER.tar.gz")
    extract_dir = os.path.expanduser("~/iFbToolKit/")
...
def main_menu():
    ...
    banner_2()
    lodhirt()
    running(('{}Try login with token & cookies using kiwi browser,\nGet token by TokenExtractor & Cookiedough, extraction.{}').format(ipurplemix, finished))
...
def allin1_install():
    ...
    if inp == '1' or inp == '01':
        ...
        os.system('xdg-open https://mega.nz/file/saEi1YgK#ACDY_ta245njAPc6QdH6-m5iUCOl8ULql4NLO8vy1z0')
        allin1_install()
    elif inp == '3' or inp == '03':
        os.system('xdg-open https://mega.nz/file/la8ywQqB#tXwmPbjbPt3_i0lt05Vc4PuJ4k4uqtiCwg5qI0j6bt0')
        allin1_install()
...
def updatetool():
        ...
        time.sleep(10)
        os.system('rm -rf $HOME/iFbToolKit;cd $HOME;git clone https://github.com/MrGhostOfficial/iFbToolKit.git;cd ~/iFbToolKit;chmod +x ifbtoolkit.py;bash $PREFIX/share/ighost/ghost.update;echo;ls;echo')
        time.sleep(2)
        sys.exit()
        #T̂͗̋͛̏ͨ̚͜a͍͚͖͙̞̰̔ͣͩ̈̍̅̑a͈͍̐͛̎̑́͐r͏͉̖̙̲̘͎͇m̴̪ͯ̌o̰̼͔̪͈̺̟ͤ͌̓s̡͙̪̣͚̮̠͇̈
def telegram():
