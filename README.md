...
<p align="center"> <img src="https://img.shields.io/github/repo-size/MrGhostOfficial/iFbToolKit.svg"/></center></p>
...
# [ Setup & run Script ]
```
git clone https://github.com/MrGhostOfficial/iFbToolKit.git
```
```
cd iFbToolKit
```
```
chmod +x ifbtoolkit.py
```
```
...
<img src=1![Screenshot_image](https://github.com/MrGhostOfficial/Allin1Images/blob/master/Screenshot_iFbToolKit1.jpg)

img src=2![Screenshot_image](https://github.com/MrGhostOfficial/Allin1Images/blob/master/Screenshot_iFbToolKit2.jpg)

img src=3![Screenshot_image](https://github.com/MrGhostOfficial/Allin1Images/blob/master/Screenshot_iFbToolKit3.jpg)
